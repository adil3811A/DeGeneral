package com.adll.de_general.feature.chat.data
 ...
 *
 * Deliberately thin, like [com.adll.de_general.feature.journal.data.JournalRepository]. It
...
class ChatRepository(
     ...
     * list, and the prompt then omits the context section rather than sending an empty one.
     */
    ...
    /** Deletes every chat message — the "Clear chat" button. Journal rows are untouched. */
