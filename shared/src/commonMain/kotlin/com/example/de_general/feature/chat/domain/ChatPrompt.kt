 ...
 *
 * [journalContext] is the raw text of the person's most recent entries, newest first, exactly as
 * the screen's context chip counts them: if the chip says three, three are in here. An empty list
