...
plugins {
    ...
    // Generates serialisers for the @Serializable navigation routes. Without it navigation
...
kotlin {
    // Room generates `actual` objects for @ConstructedBy databases, which
    // otherwise warn that expect/actual classes are still in Beta.
    compilerOptions {
...
dependencies {
    ...
    // Room's annotation processor has to run for every compilation target.
