...
internal enum class MainTab(val label: String, val route: Any) {
    ...
    Chat("Chat", com.adll.de_general.navigation.Chat),
    Journal("Journal", com.adll.de_general.navigation.Journal),
    Settings("Settings", com.adll.de_general.navigation.Settings),
}
